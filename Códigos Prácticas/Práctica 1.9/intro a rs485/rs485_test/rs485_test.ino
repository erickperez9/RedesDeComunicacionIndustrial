...
void TestRS485 (int mode){
  ...
  switch (mode){
    ...
    Serial3.println("UUUUU Controllino RS485 test Message 0.UUUUU");
    break;
    ...
    Serial3.println("UUUUU Controllino RS485 test Message 1.UUUUU");
    break;
    ...
    Serial3.println("UUUUU Controllino RS485 test Message 2.UUUUU");
    break;
